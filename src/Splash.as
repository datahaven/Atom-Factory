package  
{
	...
	public class Splash extends Entity
	{
		 ...
		 * Embedded graphics.
		 */
		[Embed(source = '../assets/splash_lines.png')] private const SPLASH_LINES:Class;
		[Embed(source = '../assets/splash_cog.png')] private const SPLASH_COG:Class;
		[Embed(source = '../assets/splash_left.png')] private const SPLASH_LEFT:Class;
		[Embed(source = '../assets/splash_right.png')] private const SPLASH_RIGHT:Class;
		 ...
		 */
		public function Splash(color:uint = 0xFF3366, bgColor:uint = 0x606060, fadeTime:Number = .5, spinTime:Number = 2, spinPause:Number = .5, spins:Number = 720) 
		{
